...
| `gamma (γ)`      | Damping factor in mode contributions | Small γ → sharp, symmetric patterns; Medium γ → slight asymmetry; Large γ → diffuse, complex patterns; controls resonance width and imperfections|
